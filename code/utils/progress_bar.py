...
class ProgressBar(object):
    ...
    def __init__(self, mode, epoch=None, total_epoch=None, current_loss=None, current_top1=None,
                 model_name=None, path=None,
    ...
    def done(self):
        ...
        with open("%s%s.txt" % (self.path, self.model_name), "a") as f:
