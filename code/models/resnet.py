...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.concat_function = nn.Sequential(
            nn.Conv2d(2 * out_channels, out_channels, stride=1, kernel_size=1, bias=False)
        )
    ...
    def forward(self, x):
        ...
        # x2 = self.shortcut(x)
        # x = torch.cat([x1, x2], 1)
        # return nn.ReLU(inplace=True)(self.concat_function(x))
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes):
        ...
        # self.fc2 = nn.Linear(block.expansion, num_classes)
